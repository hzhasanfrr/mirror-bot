This is a Telegram Bot written in Python for mirroring files on the Internet to your Google Drive or Telegram. Based on []()

# Features:

## By [Hz Hasan](https://github.com/anasty17)
- qBittorrent
